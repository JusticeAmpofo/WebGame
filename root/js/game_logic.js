    ...
    function MainMenu()
    {
        ...
        context.font = '40px Verdana';
        context.fillStyle = 'white';
        context.fillText('Rotate your device to collect the coins!!', canvas.width/2 , canvas.height/2);
    ...
    function gameOver()
    {
        ...
        if(player.faceCol == "green")
        {
          ...
          context.fillText('New High Score!', canvas.width/2 , canvas.height/2 - 250);
        }
